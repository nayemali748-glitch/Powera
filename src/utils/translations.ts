...
export const translations: Record<Language, Translations> = {
  bn: {
    ...
    entryCreatedSuccess: 'নতুন এন্ট্রি সফলভাবে সম্পন্ন হয়েছে!',
    ...
    getGps: 'জিপিএস নিন',
    photoEvidence: 'কাজের ছবি (Photo Evidence)',
    ...
    consumerId: 'কনজিউমার আইডি (Consumer ID / App No)',
    applicationNo: 'কোটা / সিএ নম্বর (CA / Quota No)',
    mobileNo: 'গ্রাহকের মোবাইল নং',
    appliedLoad: 'অনুমোদিত লোড (Applied Load in kW)',
    phaseSupply: 'সরবরাহ ফেজ (Supply Phase)',
    singlePhase: 'সিঙ্গেল ফেজ (1-Phase 230V)',
    threePhase: 'থ্রি ফেজ (3-Phase 400V)',
    tariffCategory: 'ট্যারিফ ক্যাটাগরি (Tariff Class)',
    ...
    meterNo: 'মিটার সিরিয়াল নম্বর',
    meterMake: 'মিটারের মেক (Brand/Make)',
    initialReading: 'শুরুর মিটার রিডিং (kWh)',
    sealNo: 'সিকিউরিটি সিল নম্বর (WBSEDCL Hologram Seal)',
    serviceCableLength: 'সার্ভিস কেবল সাইজ ও দৈর্ঘ্য (Meters)',
  ...
  en: {
    ...
    entryCreatedSuccess: 'New entry submitted successfully!',
    ...
    consumerId: 'Consumer ID / App No (9 Digits)',
    applicationNo: 'CA / Quota Number',
  ...
  hi: {
    ...
    entryCreatedSuccess: 'नई प्रविष्टि सफलतापूर्वक दर्ज की गई!',
    ...
    getGps: 'जीपीएस लें',
    photoEvidence: 'कार्य का फोटो साक्ष्य',
    ...
    consumerId: 'कंज्यूमर आईडी (Consumer ID / App No)',
    applicationNo: 'सीए / कोटा नंबर (CA / Quota No)',
    mobileNo: 'उपभोक्ता का मोबाइल नंबर',
    appliedLoad: 'स्वीकृत लोड (Applied Load in kW)',
    phaseSupply: 'आपूर्ति चरण (Phase)',
    singlePhase: 'सिंगल फेज (1-Phase 230V)',
    threePhase: 'थ्री फेज (3-Phase 400V)',
    tariffCategory: 'टैरिफ श्रेणी (Tariff Class)',
    ...
    meterNo: 'मीटर सीरियल नंबर',
    meterMake: 'मीटर मेक (Genus/Secure/HPL/L&T)',
    initialReading: 'प्रारंभिक मीटर रीडिंग (kWh)',
    sealNo: 'सिक्योरिटी सील नंबर (WBSEDCL Hologram Seal)',
    serviceCableLength: 'सर्विस केबल का आकार एवं लंबाई (Meters)',
  ...
  ur: {
    ...
    entryCreatedSuccess: 'نیا اندراج کامیابی سے محفوظ ہو گیا!',
    ...
    photoEvidence: 'کام کی تصویری ثبوت',
    ...
    consumerId: 'صارف آئی ڈی (Consumer ID / App No)',
    applicationNo: 'کوٹہ / سی اے نمبر (CA / Quota No)',
    mobileNo: 'صارف کا موبائل نمبر',
    appliedLoad: 'منظور شدہ لوڈ (Applied Load in kW)',
    phaseSupply: 'سپلائی فیز (Phase)',
    singlePhase: 'سنگل فیز (1-Phase 230V)',
    threePhase: 'تھری فیز (3-Phase 400V)',
    tariffCategory: 'ٹیرف کلاس (Tariff Class)',
    ...
    meterNo: 'میٹر سیریل نمبر',
    meterMake: 'میٹر میک (Genus/Secure/HPL/L&T)',
    initialReading: 'ابتدائی میٹر ریڈنگ (kWh)',
    sealNo: 'سیکیورٹی سیل نمبر (WBSEDCL Hologram Seal)',
    serviceCableLength: 'سروس کیبل کا سائز اور لمبائی (Meters)',
